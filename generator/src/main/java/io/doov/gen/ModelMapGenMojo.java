...
public final class ModelMapGenMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            Class<? extends VirtualFieldRegistry> virtualFieldClazz = loadClassWithType(virtualFields,
                    VirtualFieldRegistry.class, VirtualFields.class, classLoader);
            ...
            generateModels(fieldClazz, modelClazz, baseClazz, typeAdapterClazz, virtualFieldClazz, typeProvider,
                    fieldPaths);
        } catch (Exception e) {
    ...
    private void generateModels(Class<? extends FieldId> fieldClazz,
            ...
            Class<? extends VirtualFieldRegistry> virtualFieldClazz,
        ...
        try {
            ...
            Runnable generateWrapper = () -> generateWrapper(fieldPathMap, modelClazz, fieldClazz, baseClazz,
                    typeAdapterClazz, virtualFieldClazz);
    ...
    private void generateWrapper(Map<FieldId, VisitorPath> fieldPaths,
            ...
            Class<? extends FieldModel> baseClazz,
            Class<? extends TypeAdapterRegistry> typeAdapterClazz,
            Class<? extends VirtualFieldRegistry> virtualFieldClazz) throws RuntimeException {
        try {
            ...
            conf.put("virtual.field.class.package", virtualFieldClazz.getCanonicalName());
            conf.put("virtual.field.class.name", virtualFieldClazz.getSimpleName());
