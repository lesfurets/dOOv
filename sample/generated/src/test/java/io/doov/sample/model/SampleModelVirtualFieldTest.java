...
import io.doov.sample.field.SampleVirtualField;
import io.doov.sample.field.SampleFieldInfo;
import io.doov.sample.wrapper.SampleModelWrapper;

public class SampleModelVirtualFieldTest {

    @Test
    public void should_update_email_hash_when_using_field_model() {
        FieldModel model = new BaseFieldModel(SampleFieldInfo.fieldInfos(), new SampleVirtualField());
    ...
    private static void should_update_email_hash_when_updating_email(FieldModel model) {
        ...
        assertThat(model.<String> get(EMAIL_HASH))
                .isNotNull()
                .isEqualTo(SampleVirtualField.sha256("foo"));
        ...
        assertThat(model.<String> get(EMAIL_HASH))
                .isNotNull()
                .isEqualTo(SampleVirtualField.sha256("bar"));
    }
}
